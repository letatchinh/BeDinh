    ...
    return new Promise(async (resolve, reject) => {
        try{
            if(!inputData.doctorId || !inputData.contentHTML || !inputData.contentMarkdown || !inputData.action){
                ...
                console.log("check data: ",typeof inputData.doctorId)
            }else{
...
let saveDoctor = async (dataInput) => {
    return new Promise(async (resolve, reject) => {
        try{
            // const jane = await db.Doctormember.create({ doctorId: "12345" });
            ...
            // await jane.save();
            if(!dataInput.doctorId | !dataInput.htmlContent || !dataInput.markdownContent){
